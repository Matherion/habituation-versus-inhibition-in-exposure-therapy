...
This query was run at `r queries[[1]]$date;` in PubMed (XXXX hits) and PsycINFO accessed through EbscoHost (XXXX hits), and exported to RIS format (called 'medline' in PubMed). The RIS files were then imported in R using `metabefor`.
