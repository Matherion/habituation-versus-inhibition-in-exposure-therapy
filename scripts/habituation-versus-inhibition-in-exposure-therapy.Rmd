...
screening1_filename_pre <- paste0(queries[[1]]$date, "-screened.bib");
firstQueryScreened <-
...
```{r query-1-import-screened-hits-details}


firstQueryScreened$records[grepl('incl', firstQueryScreened$records$screening1),
                           c('author', 'title', 'year')];
