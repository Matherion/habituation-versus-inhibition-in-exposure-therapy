...
tidyTreatments$cleanIngredient <-
  dplyr::case_when(tidyTreatments$ingredient == "fearHierarchy" ~ "Angsthiërarchie",
                   tidyTreatments$ingredient == "fearMon" ~ "Angstmonitoring",
                   tidyTreatments$ingredient == "lvlBasedFear" ~ "Einde: angstniveau",
                   tidyTreatments$ingredient == "lvlBasedExpect" ~ "Einde: verwachtingsniveau",
                   ...
                   tidyTreatments$ingredient == "expBasedExpect" ~ "Einde: verwachtingsdisconfirmatie",
  ...
  res <-
    ...
    ggplot2::theme(panel.grid = ggplot2::element_blank(),
                   ...
                   legend.box.background = ggplot2::element_rect(fill = "transparent",
                                                                 color = "transparent")) +
    ggplot2::labs(title = "Exposure ingrediënten",
                  x = "Studie",
                  y = "Ingrediënt");
